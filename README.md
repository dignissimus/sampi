...
We evaluated Sampi using the MPI Graph500 benchmark in a weak scaling configuration. Broadly, the profiling overhead is minimal, and automated rank reordering gives a 25% improvement for both BFS and SSSP, tested at the 99% significance level (p < 0.001).
