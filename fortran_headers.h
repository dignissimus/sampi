...
extern "C" {
    ...
    DECLARE_PMPI_VARIANTS(waitany, WAITANY, (int *count, MPI_Fint *requests_f, int *index, MPI_Fint *status_f, int *ierror))
    DECLARE_PMPI_VARIANTS(waitsome, WAITSOME, (int *incount, MPI_Fint *requests_f, int *outcount, int *indices, MPI_Fint *statuses_f, int *ierror))
    ...
    DECLARE_PMPI_VARIANTS(testany, TESTANY, (int *count, MPI_Fint *requests_f, int *index, int *flag, MPI_Fint *status_f, int *ierror))
    DECLARE_PMPI_VARIANTS(testsome, TESTSOME, (int *incount, MPI_Fint *requests_f, int *outcount, int *indices, MPI_Fint *statuses_f, int *ierror))

    // Persistent communication
    DECLARE_PMPI_VARIANTS(send_init, SEND_INIT, (const void *buf, int *count, MPI_Fint *datatype, int *dest, int *tag, MPI_Fint *comm, MPI_Fint *request_f, int *ierror))
    DECLARE_PMPI_VARIANTS(recv_init, RECV_INIT, (void *buf, int *count, MPI_Fint *datatype, int *source, int *tag, MPI_Fint *comm, MPI_Fint *request_f, int *ierror))
    ...
    DECLARE_PMPI_VARIANTS(ibarrier, IBARRIER, (MPI_Fint *comm, MPI_Fint *request_f, int *ierror))
    DECLARE_PMPI_VARIANTS(ibcast, IBCAST, (void *buffer, int *count, MPI_Fint *datatype, int *root, MPI_Fint *comm, MPI_Fint *request_f, int *ierror))
    DECLARE_PMPI_VARIANTS(ireduce, IREDUCE, (const void *sendbuf, void *recvbuf, int *count, MPI_Fint *datatype, MPI_Fint *op, int *root, MPI_Fint *comm, MPI_Fint *request_f, int *ierror))
    DECLARE_PMPI_VARIANTS(iallreduce, IALLREDUCE, (const void *sendbuf, void *recvbuf, int *count, MPI_Fint *datatype, MPI_Fint *op, MPI_Fint *comm, MPI_Fint *request_f, int *ierror))
    ...
    DECLARE_PMPI_VARIANTS(win_create, WIN_CREATE, (void *base, MPI_Aint *size, int *disp_unit, MPI_Fint *info, MPI_Fint *comm, MPI_Fint *win_f, int *ierror))
    DECLARE_PMPI_VARIANTS(file_open, FILE_OPEN, (MPI_Fint *comm, const char *filename, int *amode, MPI_Fint *info, MPI_Fint *file_f, int *ierror, int filename_len))
