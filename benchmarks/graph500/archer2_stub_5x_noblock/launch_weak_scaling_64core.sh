...
CONF_DIR="./benchmarks/graph500/archer2_stub_5x_noblock/config"
SUITE_TIMESTAMP=$(date +"%Y%m%d_%H%M%S")
export RESULTS_BASE_DIR="./benchmarks/graph500/archer2_stub_5x_noblock/results/64-core/suite_${SUITE_TIMESTAMP}"
